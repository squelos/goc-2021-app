    ...
    return (<View style={{flex: 1}}>
        <View style={{flex: 1, marginTop: 72}}>
            <View style={{paddingHorizontal: 56}}>
                <Text style={{alignSelf: 'center', fontSize: 32, textAlign: 'center', fontWeight: 'bold'}}>Je suis un conseiler
                    SnapZen</Text>
            </View>
    ...
    return (<View style={{flex: 1}}>
        <View style={{flex: 1, marginTop: 80}}>
            ...
            <View style={{paddingHorizontal: 24, marginTop: 40}}>
                <Button style={buttonStyle(commonStyle.purpleColor)} onPress={() => navigation.navigate('Sharing')}>
